...
goog.exportSymbol('proto.album.SimpleAlbum', null, global);
 ...
 * @constructor
 */
proto.album.SimpleAlbum = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.album.SimpleAlbum.repeatedFields_, null);
};
goog.inherits(proto.album.SimpleAlbum, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.album.SimpleAlbum.displayName = 'proto.album.SimpleAlbum';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.album.SimpleAlbum.repeatedFields_ = [5,7];
 ...
 * @return {!Object}
 */
proto.album.SimpleAlbum.prototype.toObject = function(opt_includeInstance) {
  return proto.album.SimpleAlbum.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.album.SimpleAlbum} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.album.SimpleAlbum.toObject = function(includeInstance, msg) {
  var f, obj = {
    albumid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    spotifyuri: jspb.Message.getFieldWithDefault(msg, 2, ""),
    spotifyurl: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 */
proto.album.SimpleAlbum.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.album.SimpleAlbum;
  return proto.album.SimpleAlbum.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.album.SimpleAlbum} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.album.SimpleAlbum}
 */
proto.album.SimpleAlbum.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.album.SimpleAlbum.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.album.SimpleAlbum.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.album.SimpleAlbum} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.album.SimpleAlbum.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAlbumid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.album.SimpleAlbum.prototype.getAlbumid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.setAlbumid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.album.SimpleAlbum.prototype.getSpotifyuri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.setSpotifyuri = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.album.SimpleAlbum.prototype.getSpotifyurl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.setSpotifyurl = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.album.SimpleAlbum.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {!Array<!proto.album.SimpleArtist>}
 */
proto.album.SimpleAlbum.prototype.getArtistsList = function() {
  return /** @type{!Array<!proto.album.SimpleArtist>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.album.SimpleArtist, 5));
};
 ...
 * @return {!proto.album.SimpleAlbum} returns this
*/
proto.album.SimpleAlbum.prototype.setArtistsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 5, value);
};
 ...
 * @return {!proto.album.SimpleArtist}
 */
proto.album.SimpleAlbum.prototype.addArtists = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.album.SimpleArtist, opt_index);
};
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.clearArtistsList = function() {
  return this.setArtistsList([]);
};
 ...
 * @return {string}
 */
proto.album.SimpleAlbum.prototype.getCoverurl = function() {
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.setCoverurl = function(value) {
 ...
 * @return {!Array<string>}
 */
proto.album.SimpleAlbum.prototype.getGenresList = function() {
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.setGenresList = function(value) {
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.addGenres = function(value, opt_index) {
 ...
 * @return {!proto.album.SimpleAlbum} returns this
 */
proto.album.SimpleAlbum.prototype.clearGenresList = function() {
  return this.setGenresList([]);
};
