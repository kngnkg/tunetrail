...
var file_user_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x7b, 0x0a, 0x0b, 0x55,
	0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x0b, 0x47, 0x65,
	...
	0x22, 0x00, 0x12, 0x34, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
...
var file_user_proto_depIdxs = []int32{
	1, // 0: user.UserService.GetUserById:input_type -> user.GetByIdRequest
	0, // 1: user.UserService.CreateUser:input_type -> user.CreateRequest
	2, // 2: user.UserService.GetUserById:output_type -> user.UserReply
	2, // 3: user.UserService.CreateUser:output_type -> user.UserReply
